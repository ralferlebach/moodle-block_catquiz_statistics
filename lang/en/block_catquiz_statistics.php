...
$string['report:activity_disabled'] = 'Learning Activity tracking is not enabled. Set enablemoduled=1 in the plugin settings.';
$string['report:col_attempt_rank'] = 'Attempt no.';
$string['report:col_attemptid'] = 'Attempt ID';
$string['report:col_best_score'] = 'Best score';
...
$string['report:col_difficulty'] = 'Difficulty';
...
$string['report:col_items_per_attempt'] = 'Items per attempt';
$string['report:col_items_productive'] = 'Items (productive)';
$string['report:col_items_total'] = 'Items (total)';
$string['report:col_last_score'] = 'Last score';
$string['report:col_last_starttime'] = 'Last attempt';
$string['report:col_lastname'] = 'Last name';
$string['report:col_lastresponse'] = 'Response (fraction)';
$string['report:col_max'] = 'Max';
$string['report:col_mean'] = 'Mean';
$string['report:col_mean_ability_before'] = 'Mean ability (before item)';
$string['report:col_mean_fisher'] = 'Mean Fisher information';
$string['report:col_mean_response'] = 'Mean response';
$string['report:col_median'] = 'Median';
$string['report:col_min'] = 'Min';
$string['report:col_n'] = 'N';
$string['report:col_n_attempts'] = 'No. of attempts';
$string['report:col_n_correct'] = 'N correct';
$string['report:col_n_incorrect'] = 'N incorrect';
$string['report:col_n_partial'] = 'N partial';
$string['report:col_n_presented'] = 'N presented';
$string['report:col_n_valid'] = 'No. attempts (valid)';
$string['report:col_parent_label'] = 'Parent scale';
$string['report:col_personability_after'] = 'Ability after step';
$string['report:col_q1'] = 'Q1';
$string['report:col_q3'] = 'Q3';
$string['report:col_questionname'] = 'Question';
$string['report:col_questionscale'] = 'Scale ID';
$string['report:col_questionscale_name'] = 'Scale name';
$string['report:col_rci'] = 'RCI';
$string['report:col_rci_min_max'] = 'RCI Min-Max';
$string['report:col_rci_start_end'] = 'RCI Start-End';
$string['report:col_result_scale_id'] = 'Result scale ID';
$string['report:col_result_scale_name'] = 'Result scale';
$string['report:col_result_score'] = 'Result scale Score';
$string['report:col_result_se'] = 'Result scale SE';
...
$string['report:meta_sheet_metadata'] = 'Export metadata and scale hierarchy';
...
$string['report:meta_sheet_subscale_scores'] = 'Score per attempt × subscale';
$string['report:meta_sheet_subscale_se'] = 'Standard error per attempt × subscale (validity check)';
$string['report:meta_sheet_usage_raw'] = 'Individual attempts (all, flat)';
$string['report:meta_sheet_usage_summary'] = 'Aggregated: one row per user × global scale';
...
$string['report:sheet_subscale_se'] = 'Results (SE)';
$string['report:sheet_usage_metadata'] = 'Metadata';
$string['report:sheet_usage_raw'] = 'Testversuche (Rohdaten)';
$string['report:sheet_usage_scale'] = 'Test Usage (Scale';
$string['report:sheet_usage_summary'] = 'Test Usage (all)';
