...
$string['report:activity_disabled'] = 'Lernangebotsnutzung ist nicht aktiviert. Bitte enablemoduled=1 in den Plugin-Einstellungen setzen.';
$string['report:col_attempt_rank'] = 'Versuch Nr.';
$string['report:col_attemptid'] = 'Versuchs-ID';
$string['report:col_best_score'] = 'Bestes Ergebnis';
...
$string['report:col_first_score'] = 'Erstes Ergebnis';
$string['report:col_first_starttime'] = 'Erster Versuch';
$string['report:col_firstname'] = 'Vorname';
$string['report:col_fisherinformation'] = 'Fisher-Information';
$string['report:col_frac_correct'] = 'Loesungsquote';
...
$string['report:col_items_per_attempt'] = 'Items pro Versuch';
$string['report:col_items_productive'] = 'Items (produktiv)';
$string['report:col_items_total'] = 'Items (gesamt)';
$string['report:col_last_score'] = 'Letztes Ergebnis';
$string['report:col_last_starttime'] = 'Letzter Versuch';
...
$string['report:col_mean_ability_before'] = 'Mittl. Faehigkeit (vor Item)';
$string['report:col_mean_fisher'] = 'Mittl. Fisher-Information';
$string['report:col_mean_response'] = 'Mittlere Antwort';
$string['report:col_median'] = 'Median';
$string['report:col_min'] = 'Min';
$string['report:col_n'] = 'Anzahl';
$string['report:col_n_attempts'] = 'Anzahl Versuche';
$string['report:col_n_correct'] = 'Anzahl korrekt';
$string['report:col_n_incorrect'] = 'Anzahl falsch';
$string['report:col_n_partial'] = 'Anzahl teilrichtig';
$string['report:col_n_presented'] = 'Anzahl Praesentation';
$string['report:col_n_valid'] = 'Anz. Versuche (gueltig)';
...
$string['report:col_result_scale_id'] = 'Ergebnisskala ID';
$string['report:col_result_scale_name'] = 'Ergebnisskala';
$string['report:col_result_score'] = 'Ergebnisskala Score';
$string['report:col_result_se'] = 'Ergebnisskala SE';
...
$string['report:col_total_items'] = 'Items beantwortet (gesamt)';
...
$string['report:col_worst_score'] = 'Niedrigstes Ergebnis';
...
$string['report:meta_sheet_metadata'] = 'Export-Metadaten und Skalenhierarchie';
...
$string['report:meta_sheet_subscale_scores'] = 'Score je Versuch × Subskala';
$string['report:meta_sheet_subscale_se'] = 'Standard-SE je Versuch × Subskala (Validitätsprüfung)';
$string['report:meta_sheet_usage_raw'] = 'Einzelversuche (alle, flach)';
$string['report:meta_sheet_usage_summary'] = 'Aggregiert: eine Zeile je Nutzer × Globalskala';
...
$string['report:sheet_subscale_se'] = 'Ergebnisse (SE)';
$string['report:sheet_usage_metadata'] = 'Metadaten';
$string['report:sheet_usage_raw'] = 'Testversuche (Rohdaten)';
$string['report:sheet_usage_scale'] = 'Testnutzung (Skala';
$string['report:sheet_usage_summary'] = 'Testnutzung (gesamt)';
